/*
  ...
  - Made the column `trxref` on table `Order` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_Order" ("addressType", "billingAddressId", "createdAt", "id", "paymentInfoId", "phoneNumber", "pickUpPersonFirstName", "pickUpPersonLastName", "shippingAddressId", "shippingFeeInCents", "status", "taxRate", "totalPriceInCents", "trxref", "updatedAt", "userId") SELECT "addressType", "billingAddressId", "createdAt", "id", "paymentInfoId", "phoneNumber", "pickUpPersonFirstName", "pickUpPersonLastName", "shippingAddressId", "shippingFeeInCents", "status", "taxRate", "totalPriceInCents", "trxref", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
ALTER TABLE "new_Order" RENAME TO "Order";
CREATE UNIQUE INDEX "Order_trxref_key" ON "Order"("trxref");
