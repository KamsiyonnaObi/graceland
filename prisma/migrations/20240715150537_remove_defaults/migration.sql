...
INSERT INTO "new_Order" ("addressType", "billingAddressId", "createdAt", "id", "paymentInfoId", "shippingAddressId", "shippingFeeInCents", "status", "taxInCents", "totalPriceInCents", "updatedAt", "userId") SELECT "addressType", "billingAddressId", "createdAt", "id", "paymentInfoId", "shippingAddressId", "shippingFeeInCents", "status", "taxInCents", "totalPriceInCents", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
