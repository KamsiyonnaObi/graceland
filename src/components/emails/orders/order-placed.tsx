...
export const OrderPlaced: React.FC<OrderProps> = ({
  order,
  items,
  shippingAddress,
}) => {
    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          <p style={{ margin: "0" }}> {order.orderEmail}</p>
          <p style={{ margin: "0" }}> {order.phoneNumber}</p>
        </div>
      </div>
      ...
      {order.FulfillmentType === "SHIPPING" && (
        ...
        >
          <p style={{ margin: "0 26px 0 0", fontWeight: "bold" }}>
            {" "}
      ...
      {order.FulfillmentType === "SHIPPING" &&
        order.deliveryNote &&
        order.deliveryNote.trim().length > 0 && (
          <div
            style={{
              display: "flex",
              flexDirection: "row",
          ...
          >
            <p style={{ margin: "0 35px 0 0", fontWeight: "bold" }}>
              {" "}
            ...
            >
              <p style={{ margin: "0" }}> {order.deliveryNote}</p>
            </div>
          </div>
        )}
      <div
