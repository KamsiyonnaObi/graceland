  ...
  return (
    <div className="container mx-auto">
      ...
      <section className="mb-6 space-y-2">
        ...
        <p>
          This website is operated by Graceland Nigeria. Throughout the site,
          the terms “we”, “us” and “our” refer to Graceland Nigeria. Graceland
          Nigeria offers this website, including all information, tools and
      ...
      <section className="mb-6 space-y-2">
        ...
        <p>
          ...
          Return Policy. To view our Return Policy, please visit{" "}
          <Link
      ...
      <section className="mb-6 space-y-2">
        ...
        <p>
          ...
          obscene or otherwise objectionable or violates any part&apos;s
      ...
      <section className="mb-6 space-y-2">
        ...
        <p>
          ...
          case shall Graceland Nigeria, our directors, officers, employees,
      ...
      <section className="mb-6 space-y-2">
        ...
        <p>
          You agree to indemnify, defend and hold harmless Graceland Nigeria and
      ...
      <section className="mb-6 space-y-2">
        ...
        <p>
          ...
          <a href="mailto:info.gracelandng@gmail.com" className="text-blue-500">
        ...
        <ul>
          <li>GRACELAND NIGERIA</li>
          <li>info.gracelandng@gmail.com</li>
          <li>43 Oroyinyin Street, Idumota-Lagos, Nigeria</li>
          <li>+2348034461024</li>
        </ul>
      </section>
    </div>
